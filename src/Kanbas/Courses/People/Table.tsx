            ...
            <table className="table table-striped">
                ...
                <tbody>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-total-activity">10:51:52</td> </tr>

                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        <span className="wd-first-name">Steve</span>{" "}
                        <span className="wd-last-name">Rogers</span></td>
                        <td className="wd-login-id">001234599S</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                    ...
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-login-id">001234678S</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-10-11</td>
                        <td className="wd-total-activity">19:21:32</td> </tr>
                </tbody>
            </table>
        </div>);
}
